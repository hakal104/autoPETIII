...
from nnunetv2.preprocessing.normalization.default_normalization_schemes import CTNormalization, NoNormalization, \
    ZScoreNormalization, RescaleTo01Normalization, RGBTo01Normalization, ImageNormalization, CTNormalizationFixed, PetZScoreNormalization

channel_name_to_normalization_mapping = {
    'ct': CTNormalization,
    'ctfixed': CTNormalizationFixed,
    'petzscore': PetZScoreNormalization,
