...
class PetZScoreNormalization(ImageNormalization):
...
class CTNormalizationFixed(ImageNormalization):
    leaves_pixels_outside_mask_at_zero_if_use_mask_for_norm_is_true = False

    def run(self, image: np.ndarray, seg: np.ndarray = None) -> np.ndarray:
        assert self.intensityproperties is not None, "CTNormalization requires intensity properties"
        mean_intensity = 107.51772547914071
        std_intensity = 286.2641635921368
        lower_bound = -832.3585205078125
        upper_bound = 1128.3473400878847
